...
function solve(jsonArray){
    ...
    const sortedEntries = Object.entries(dictionary).sort(([keyA], [keyB]) => keyA.localeCompare(keyB)); // Object to array so we can sort it.
    
    const sortedDictionary = Object.fromEntries(sortedEntries); // Back to dictionary, but now sorted
